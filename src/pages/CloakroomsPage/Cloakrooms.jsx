...
import s from './Cloakrooms.module.sass'
import Button from '../../components/getConsultationButton/Button'
import firstImage from "../../images/гардеробные/1.jpg"
function Cloakrooms() {
    ...
    useEffect(() => {
        for(let i = 1; i <= 9; i++){
            import(`../../images/гардеробные/${i}.jpg`)
    ...
    <div className={s.container}>
        <div className={s.innerContainer}>
            ...
            <div className={s.bottomSide}>
                <div className={s.left}>
                    <img src="https://fason-kuhni.ru/wp-content/uploads/2021/03/5-min-1.jpg" alt="" />
                </div>

                <div className={s.right}>
                    <h1>Как заказать гардеробную в Merbau</h1>
